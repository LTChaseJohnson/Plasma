...
\begin{figure}[p]
\centering
\includegraphics[width=0.7\linewidth]{"../../../Dropbox/Graduate_School/Plasma/Plasma References/Chapman1"}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.7\linewidth]{"../../../Dropbox/Graduate_School/Plasma/Plasma References/Hastie1"}
