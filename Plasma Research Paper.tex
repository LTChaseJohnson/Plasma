...
\begin{SCfigure}
  ...
  \caption{An intial perturbation generates magnetic pressure to counter. However, magnetic field diffusion occurs rapidly in locations of strong flux gradients. As magnetic field diffuses, perturbation is allowed to grow and alter topology.$^{11}$}
  \label{fig:Dendy1}}
\end{SCfigure}
