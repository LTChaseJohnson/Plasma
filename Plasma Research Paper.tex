...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\linewidth]{"../../../Dropbox/Graduate_School/Plasma/Plasma References/Chapman4"}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{"../../../Dropbox/Graduate_School/Plasma/Plasma References/Chapman5"}
